...
class Validation {
    ...
    public function pattern($name){
        ...
        if($name == 'array'){
            ...
            if(!is_array($this->value)){
                $this->errors[$this->name][] = 'Format '.$this->name.' tidak valid.';
            }
    ...
    public function required(){
        ...
        if((isset($this->file) && $this->file['error'] == 4) || ($this->value == '' || $this->value == null)){
            $this->errors[$this->name][] = 'Kolom '.$this->name.' wajib diisi.';
        }
        return $this;
    ...
    public function min($length){
        ...
        if(is_string($this->value)){
            ...
            if(strlen($this->value) < $length){
                $this->errors[$this->name][] = 'Kolom '.$this->name.' minimal '.$length.' karakter';
            }

        }else{

            if($this->value < $length){
                $this->errors[$this->name][] = 'Kolom '.$this->name.' bernilai kurang dari '.$length;
            }
    ...
    public function max($length){
        ...
        if(is_string($this->value)){
            ...
            if(strlen($this->value) > $length){
                $this->errors[$this->name][] = 'Valore campo '.$this->name.' superiore al valore massimo';
            }
    ...
    public function equal($value){
        ...
        if($this->value != $value){
            $this->errors[$this->name][] = 'Valore campo '.$this->name.' non corrispondente.';
        }
        return $this;
